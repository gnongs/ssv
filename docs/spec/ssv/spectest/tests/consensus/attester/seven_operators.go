...
func SevenOperators() *tests.SpecTest {
	dr := testingutils.AttesterRunner7Operators()
	...
	msgs := []*types.SSVMessage{
		...
		testingutils.SSVMsgAttester(testingutils.SignQBFTMsg(testingutils.TestingSK4, 4, &qbft.Message{
			MsgType:    qbft.PrepareMsgType,
			Height:     qbft.FirstHeight,
			Round:      qbft.FirstRound,
			Identifier: testingutils.AttesterMsgID,
		...
		testingutils.SSVMsgAttester(testingutils.SignQBFTMsg(testingutils.TestingSK5, 5, &qbft.Message{
			MsgType:    qbft.PrepareMsgType,
			Height:     qbft.FirstHeight,
			Round:      qbft.FirstRound,
			Identifier: testingutils.AttesterMsgID,
		...
		testingutils.SSVMsgAttester(nil, testingutils.PostConsensusAttestationMsg(testingutils.TestingSK5, 5, qbft.FirstHeight)),
	}
